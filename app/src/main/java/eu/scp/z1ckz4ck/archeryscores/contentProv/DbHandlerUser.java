...
public class DbHandlerUser extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "(" + USER_ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " + EMail + " TEXT NOT NULL, " + FIRSTNAME + " TEXT, " + LASTNAME + " TEXT)";
    ...
    public User getUser(int id) {
        ...
        Cursor cursor = db.query(TABLE_USER, new String[]{USER_ID, EMail, FIRSTNAME, LASTNAME}, USER_ID + "=?", new String[]{String.valueOf(id)}, null, null, null);
        if (cursor != null) {
            cursor.moveToFirst();
